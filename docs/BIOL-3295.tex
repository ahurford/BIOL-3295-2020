...
## -0.53923 -0.16071  0.00451  0.19579  0.53812 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -2.078661   0.536591  -3.874 0.000307 ***
## since.225    0.033130   0.002142  15.464  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.2386 on 51 degrees of freedom
## Multiple R-squared:  0.8242, Adjusted R-squared:  0.8208 
## F-statistic: 239.1 on 1 and 51 DF,  p-value: < 2.2e-16
\end{verbatim}
...
\chapter{Thurs Oct 29-Fri Oct 30:
Midterm}\label{thurs-oct-29-fri-oct-30-midterm}
...
The dominant eigenvalue value is the one that has largest absolute value
(i.e., if \(\lambda_1 < 0\) then \(|\lambda_1| = -\lambda_1\) and if
\(\lambda_1 >0\) then \(|\lambda_1| = \lambda_1\)).
