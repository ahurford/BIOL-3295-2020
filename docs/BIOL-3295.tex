...
\(\lambda=5\) and the population size for week 7 is 150). Show your
calculations. {[}2 marks{]}
...
\item
  ...
  15, where \(N_0=1\) and \(\lambda=5\) (the same as question 4). Show
...
\item
  ...
  what are some possible values of \(b\) and \(d\). {[}1 mark{]}
\item
...
\item
  ...
  \emph{protection-island-q3.R} {[}5 marks{]} 
\end{itemize}
...
\chapter{Fri Sept 25: Doubling times}\label{fri-sept-25-doubling-times}

{[}DRAFT{]}

\chapter{Tue Sept 29: Density dependence and logistic
growth}\label{tue-sept-29-density-dependence-and-logistic-growth}
