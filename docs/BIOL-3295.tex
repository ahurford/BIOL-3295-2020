...
## -0.49171 -0.17494  0.01424  0.18259  0.51688 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -2.829436   0.639944  -4.421 6.14e-05 ***
## since.225    0.036255   0.002587  14.015  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.2406 on 45 degrees of freedom
## Multiple R-squared:  0.8136, Adjusted R-squared:  0.8095 
## F-statistic: 196.4 on 1 and 45 DF,  p-value: < 2.2e-16
\end{verbatim}
...
\item
  ...
  into an R script. Run the example code and produce the figure. Hand in
  the figure with a figure caption (see Section \ref{figures} for
