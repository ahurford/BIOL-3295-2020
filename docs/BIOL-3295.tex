...
## -0.67298 -0.14101  0.00156  0.14413  0.55693 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -0.384650   0.305898  -1.257    0.212    
## since.225    0.026195   0.001161  22.561   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.2309 on 76 degrees of freedom
## Multiple R-squared:  0.8701, Adjusted R-squared:  0.8684 
## F-statistic:   509 on 1 and 76 DF,  p-value: < 2.2e-16
\end{verbatim}
...
\includegraphics{BIOL-3295_files/figure-latex/unnamed-chunk-56-1.pdf}
...
{Your paper/report should be no more than 10 pages single-spaced and
excluding figures and references. Your paper does not need to be this
long. Aim to make concise, well-argued points that are supported by
citations.}
...
\item
  ...
  caption (for Review papers see further instructions below). {[}20
  marks{]}
\end{enumerate}
...
{ For the figure for the Review paper you may wish to illustrate the
concepts underpinning your arguments visually. This might be similar to
a graphical abstract, conceptual diagram, or an infographic. You may
wish to sketch graphs to explain your ideas. Your diagram may be
sketched by hand, photographed, and inserted into your write-up, or you
might make it in Powerpoint or similar drawing software. You will be
graded on how well the idea of the diagram communicates your arguments,
not your graphical design skills. See
\href{https://www-nature-com.qe2a-proxy.mun.ca/articles/s41467-018-07703-y/figures/1}{here}
for an example of a good figure (Figure 1 in Gokhale, S., Conwill, A.,
Ranjan, T. et al. Migration alters oscillatory dynamics and promotes
survival in connected bacterial populations. Nat Commun 9, 5273 (2018).
\url{https://doi-org.qe2a-proxy.mun.ca/10.1038/s41467-018-07703-y}) }
