# Tues Oct 6: Solving the logistic growth equation using a computer 2

Last class we learned how to make a custom function. Today we would like to write a custom function that satisfies the requirements of the the `func` argument that is supplied to `ode()` so that numerical integration can be performed.
...
- The value returned must be a _list_ of the rates of change in the dependent variables.
...
Did you get `2`? Does it make sense to you that the returned value is `2`?
