...
3. Complete Exercise 2.15 on p40 of Vandermeer and Goldberg (2013) [3 marks]. Note that where $\mathbb{P}$ is a Leftkovitch matrix, the element $p_{ij}$ is the contribution _from_ individuals in stage $j$ at time $t$, _to_ stage $i$ at time $t+1$, 
