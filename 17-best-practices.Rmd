...
We write code to be read by a computer and other humans (including your future self!). For this reason, it's essential to ensure that your code is understandable to other people in the same way you follow proper grammar and punctuation in your writing. Programming best practices are a set of informal rules and habits that we use to improve the quality of software, and we encourage you to follow them.

## Basics

As you start to learn to program, it is useful to follow best practices and a consistent style to keep code and data organized, easy to read, share, and verify. For brevity, we focus on the most critical aspects.
