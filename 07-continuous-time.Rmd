...
In this question, we will find the equation for 'doubles every day' to help us re-create this plot in the next class. Our model is equation \@ref(eq:Exp). This means that we will calculate the equation for 'doubles every day' under the assumption that number of daily cases grows exponentially over time.
