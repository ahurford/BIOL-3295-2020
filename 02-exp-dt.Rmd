...
8. In the reading, $\lambda = 2$. Given that $\lambda = 1 + b - d$, what are some possible values of $b$ and $d$. <span style="color: red;">Note that $d$ is a fraction and must be $1 \leq d \leq 0$ and $b>0$.</span> [1 mark]
