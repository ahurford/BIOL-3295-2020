...
Navigate to the folder where you expected to save the data as a .csv file. You should be able to open the .csv file in _Microsoft Excel_.
...
2. What command did you use to save the data as a .csv file? [1 mark]
